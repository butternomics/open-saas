...
<execution_context>
@/home/user/open-saas/.claude/get-shit-done/workflows/manager.md
...
Read and execute `/home/user/open-saas/.claude/get-shit-done/workflows/analyze-dependencies.md` end-to-end.
