...
```
Agent(
  prompt="Read /home/user/open-saas/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/open-saas/.claude/get-shit-done/templates/SECURITY.md`
