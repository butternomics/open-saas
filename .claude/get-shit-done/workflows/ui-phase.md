...
```markdown
Read /home/user/open-saas/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/open-saas/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/open-saas/.claude/agents/gsd-ui-checker.md for instructions.
