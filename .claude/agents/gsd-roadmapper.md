...
Reference full template: `/home/user/open-saas/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/open-saas/.claude/get-shit-done/templates/state.md`.
