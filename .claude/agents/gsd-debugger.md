...
<required_reading>
@/home/user/open-saas/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/home/user/open-saas/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/open-saas/.claude
                  → checks /home/user/open-saas/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/open-saas/.claude/get-shit-done
                  → writes to /home/user/open-saas/.claude/get-shit-done/hooks/
...
@/home/user/open-saas/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/user/open-saas/.claude/get-shit-done/references/common-bug-patterns.md
