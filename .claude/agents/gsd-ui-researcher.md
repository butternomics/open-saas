...
Use template from `/home/user/open-saas/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/user/open-saas/.claude/get-shit-done/templates/UI-SPEC.md`
